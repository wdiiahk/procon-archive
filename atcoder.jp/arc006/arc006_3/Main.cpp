...
/**
 * トラックから運ぶ順にダンボールの重さが与えられるので、
 * ダンボールを潰さないような積み重ね方を考えなさい。
 * そして、その積み重ねた山の個数が最小となる場合の山の個数を求めなさい。 
 */
struct Args
{
  /**
   * 1行目には、ダンボールの個数を表す整数 N(1≦N≦50)が与えられる。
   */
  ll N;
  /**
   * 2行目からの N 行には、i+1(1≦i≦N) 行目に i 番目に運ぶ
   * ダンボールの重さを表す整数 wi(1≦wi≦100,000) が与えられる。 
   */
  vll w;
  Args()
  {
