...
struct Solver
{
  ...
  ll do_solve(bool front_first)
  {
    ...
    if (front_first)
    {
      q.push_back(args.a.at(l));
      l++;
      flag = true;
    }
    else
    {
      q.push_back(args.a.at(r - 1));
      r--;
      flag = false;
    }
    while (0 < r - l)
  ...
  void solve()
  {
    ans = max(do_solve(true), do_solve(false));
  }
  //
  void output()
  {
